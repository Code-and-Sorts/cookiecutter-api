...
public class KittenClawsRepository : IKittenClawsRepository
{
    ...
    private static Dictionary<string, AttributeValue> ToAttributeMap(KittenClawsEntity entity)
    {
    ...
    private static KittenClawsEntity FromAttributeMap(Dictionary<string, AttributeValue> item)
    {
        return new KittenClawsEntity
        {
