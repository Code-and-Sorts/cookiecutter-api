...
public class Update{{cookiecutter.project_class_name}}Test
{
    ...
    public async Task Patch_ReturnsUpdatedResult_When{{cookiecutter.project_class_name}}IsUpdated()
    {
        ...
        var httpRequestData = Mocks.CreateHttpRequestData(update{{cookiecutter.project_class_name}}Request, "PATCH");
        ...
        // Act
        var response = await _update{{cookiecutter.project_class_name}}Function.Patch(httpRequestData, {{cookiecutter.project_lower_camel_name}}Id);
