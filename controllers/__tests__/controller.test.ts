...
describe('CatController', () => {
    ...
    describe('update', () => {
        ...
        it('should throw validation error when the id is missing', async () => {
            await expect(mockController.update({ name: 'mockCat' })).rejects.toThrow('Missing item id.');
...
describe('DogController', () => {
    ...
    describe('replace', () => {
        ...
        it('should throw validation error when the id is missing', async () => {
            await expect(mockController.replace({ name: 'mockDog' })).rejects.toThrow('Missing item id.');
