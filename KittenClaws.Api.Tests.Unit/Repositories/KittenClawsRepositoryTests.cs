...
{
    private readonly IFirestoreContext<CatEntity> _mockContext;
    private readonly CatRepository _repository;

    public CatRepositoryTest()
    {
        _mockContext = Substitute.For<IFirestoreContext<CatEntity>>();
    ...
    public async Task GetAsync_ShouldReturnCatDto()
    {
        ...
        var item = new CatEntity { Id = id, Name = "mockCat" };
    ...
    public async Task GetAsync_ShouldThrowWhenNotFound()
    {
        ...
        _mockContext.GetAsync(id, Arg.Any<CancellationToken>()).Returns((CatEntity?)null);
    ...
    {
        var id = "0f3a7ff7-a601-4d23-b33c-7f8f18b57a4c";
        var item = new CatEntity { Id = id, Name = "mockCatNew", UpdatedBy = "User1" };
        var currentItem = new CatEntity { Id = id, Name = "mockCatOld", CreatedBy = "User2", CreatedTimestamp = DateTime.UtcNow };
        ...
        await _mockContext.Received(1).SetAsync(id, Arg.Any<CatEntity>(), Arg.Any<CancellationToken>());
    }
    ...
    {
        var id = "0f3a7ff7-a601-4d23-b33c-7f8f18b57a4c";
        var existingItem = new CatEntity { Id = id, Name = "mockCat", IsDeleted = false };
...
{
    private readonly IFirestoreContext<DogEntity> _mockContext;
    private readonly DogRepository _repository;

    public DogRepositoryTest()
    {
        _mockContext = Substitute.For<IFirestoreContext<DogEntity>>();
    ...
    {
        var id = "0f3a7ff7-a601-4d23-b33c-7f8f18b57a4c";
        var item = new DogEntity { Id = id, Name = "mockDog" };
        _mockContext.GetAsync(id, Arg.Any<CancellationToken>()).Returns(item);
    ...
    {
        var id = "non-existent-id";
        _mockContext.GetAsync(id, Arg.Any<CancellationToken>()).Returns((DogEntity?)null);
    ...
    {
        var id = "0f3a7ff7-a601-4d23-b33c-7f8f18b57a4c";
        var item = new DogEntity { Id = id, Name = "mockDogNew", UpdatedBy = "User1" };
        var currentItem = new DogEntity { Id = id, Name = "mockDogOld", CreatedBy = "User2", CreatedTimestamp = DateTime.UtcNow };
        _mockContext.GetAsync(id, Arg.Any<CancellationToken>()).Returns(currentItem);
        ...
        await _mockContext.Received(1).SetAsync(id, Arg.Any<DogEntity>(), Arg.Any<CancellationToken>());
    }
    ...
    {
        var id = "0f3a7ff7-a601-4d23-b33c-7f8f18b57a4c";
        var existingItem = new DogEntity { Id = id, Name = "mockDog", IsDeleted = false };
        _mockContext.GetAsync(id, Arg.Any<CancellationToken>()).Returns(existingItem);
