...
public class CatControllerTest
{
    ...
    public async Task GetAsync_ReturnsCatDto()
    {
        ...
        var result = await _catController.GetAsync(id, TestContext.Current.CancellationToken);
    ...
    public async Task GetListAsync_ReturnsListOfCatDto()
    {
        ...
        await _catController.GetListAsync(TestContext.Current.CancellationToken);
    ...
    public async Task CreateAsync_ReturnsCreatedCatDto()
    {
        ...
        var result = await _catController.CreateAsync(stream, TestContext.Current.CancellationToken);
    ...
    public async Task UpdateAsync_ReturnsUpdatedCatDto()
    {
        ...
        var result = await _catController.UpdateAsync(itemId, stream, TestContext.Current.CancellationToken);
    ...
    public async Task DeleteAsync_CallsDeleteOnService()
    {
        ...
        await _catController.DeleteAsync(id, TestContext.Current.CancellationToken);
...
public class DogControllerTest
{
    ...
    public async Task GetAsync_ReturnsDogDto()
    {
        ...
        var result = await _dogController.GetAsync(id, TestContext.Current.CancellationToken);
    ...
    public async Task GetListAsync_ReturnsListOfDogDto()
    {
        ...
        await _dogController.GetListAsync(TestContext.Current.CancellationToken);
    ...
    public async Task CreateAsync_ReturnsCreatedDogDto()
    {
        ...
        var result = await _dogController.CreateAsync(stream, TestContext.Current.CancellationToken);
    ...
    public async Task ReplaceAsync_ReturnsReplacedDogDto()
    {
        ...
        var result = await _dogController.ReplaceAsync(itemId, stream, TestContext.Current.CancellationToken);
    ...
    public async Task DeleteAsync_CallsDeleteOnService()
    {
        ...
        await _dogController.DeleteAsync(id, TestContext.Current.CancellationToken);
