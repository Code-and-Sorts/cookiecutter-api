...
public class KittenClawsControllerTest
{
    ...
    public async Task GetAsync_ReturnsKittenClawsDto()
    {
        ...
        var result = await _kittenClawsController.GetAsync(id, TestContext.Current.CancellationToken);
    ...
    public async Task GetListAsync_ReturnsListOfKittenClawsDto()
    {
        ...
        await _kittenClawsController.GetListAsync(TestContext.Current.CancellationToken);
    ...
    public async Task CreateAsync_ReturnsCreatedKittenClawsDto()
    {
        ...
        var result = await _kittenClawsController.CreateAsync(stream, TestContext.Current.CancellationToken);
    ...
    public async Task UpdateAsync_ReturnsUpdatedKittenClawsDto()
    {
        ...
        var result = await _kittenClawsController.UpdateAsync(itemId, stream, TestContext.Current.CancellationToken);
    ...
    public async Task DeleteAsync_CallsDeleteOnService()
    {
        ...
        await _kittenClawsController.DeleteAsync(id, TestContext.Current.CancellationToken);
