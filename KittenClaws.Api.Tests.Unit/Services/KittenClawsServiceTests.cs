...
public class CatServiceTest
{
    ...
    public async Task GetListAsync_ShouldReturnListOfCatDto()
    {
        ...
        var result = await _catService.GetListAsync(TestContext.Current.CancellationToken);
    ...
    public async Task CreateAsync_ShouldReturnCreatedCatDto()
    {
        ...
        var newCat = new CatEntity { Id = Guid.NewGuid().ToString(), Name = createRequest.Name };
        var expectedItem = new CatDto { Id = newCat.Id, Name = newCat.Name };
        _catRepositoryMock.CreateAsync(Arg.Any<CatEntity>(), Arg.Any<CancellationToken>())
            .Returns(expectedItem);

        var result = await _catService.CreateAsync(createRequest, TestContext.Current.CancellationToken);
    ...
    public async Task UpdateAsync_ShouldReturnUpdatedCatDto()
    {
        ...
        _catRepositoryMock.UpdateAsync(Arg.Any<CatEntity>(), Arg.Any<CancellationToken>())
            .Returns(expectedItem);

        var result = await _catService.UpdateAsync(updateRequest, TestContext.Current.CancellationToken);
    ...
    public async Task DeleteAsync_ShouldCallRepositoryDelete()
    {
        ...
        await _catService.DeleteAsync(itemId, TestContext.Current.CancellationToken);
...
public class DogServiceTest
{
    ...
    public async Task GetListAsync_ShouldReturnListOfDogDto()
    {
        ...
        var result = await _dogService.GetListAsync(TestContext.Current.CancellationToken);
    ...
    public async Task CreateAsync_ShouldReturnCreatedDogDto()
    {
        ...
        var newDog = new DogEntity { Id = Guid.NewGuid().ToString(), Name = createRequest.Name };
        var expectedItem = new DogDto { Id = newDog.Id, Name = newDog.Name };
        _dogRepositoryMock.CreateAsync(Arg.Any<DogEntity>(), Arg.Any<CancellationToken>())
            .Returns(expectedItem);

        var result = await _dogService.CreateAsync(createRequest, TestContext.Current.CancellationToken);
    ...
    public async Task ReplaceAsync_ShouldReturnReplacedDogDto()
    {
        ...
        _dogRepositoryMock.ReplaceAsync(Arg.Any<DogEntity>(), Arg.Any<CancellationToken>())
            .Returns(expectedItem);

        var result = await _dogService.ReplaceAsync(replaceRequest, TestContext.Current.CancellationToken);
    ...
    public async Task DeleteAsync_ShouldCallRepositoryDelete()
    {
        ...
        await _dogService.DeleteAsync(itemId, TestContext.Current.CancellationToken);
