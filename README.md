...
A health check is served at `GET /api/health`.
...
|---|---|---|
| `kitties` | KittenClaws | `FIRESTORE_COLLECTION_KITTIES` |
...
4. Set Environment Variables
    ...
    - `FIRESTORE_COLLECTION_KITTIES`: Firestore collection for the `kitties` container (defaults to `kitties`)
...
6. Deploy to GCP
    ...
    gcloud run deploy kitties-api \
      ...
      --set-env-vars GCP_PROJECT_ID=your-project-id,FIRESTORE_COLLECTION_KITTIES=kitties
    ```
